/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b1bca9caf47806d3ef7e1ea14f7f1050)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LILIUM_COMMAND_CONFIG_ID">> {}
}
